...
ctk.set_appearance_mode("dark") # começa no modo dark
ctk.set_default_color_theme("blue")    # botões azuis

janela = ctk.CTk()  # cria a janela
janela.title("Nasama") # titulo da janela
janela.geometry("700x700") # tamanho da janela
...
circulo = ctk.CTkFrame(
    ...
    width=tamanho,
    height=tamanho,
    corner_radius=tamanho // 2, # metade do tamanho
    fg_color= "#2563eb"
)
...
image = ctk.CTkImage(
    light_image=Image.open("image.png"),
    size=(80,80)
)
